...
| `barSms(msisdn, options?)`                  | `msisdn`                                      | Sets both mobile-terminated (`ts21`) and mobile-originated (`ts22`) SMS values to `0`.                                                                             |
| `unbarSms(msisdn, options?)`                | `msisdn`                                      | Sets both SMS values (`ts21` and `ts22`) to `1`.                                                                                                                   |
